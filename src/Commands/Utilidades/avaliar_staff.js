...
module.exports = {
  ...
  description: '[✨Utilidades] Avalie um staff do servidor.', // Coloque a descrição do comando
  ...
  run: async (client, interaction) => {
    ...
    const staffRoleID = '1216547674220925088' // ID cargo de staff
    const channelLogID = '1224779292781842524' // ID canal de logs
